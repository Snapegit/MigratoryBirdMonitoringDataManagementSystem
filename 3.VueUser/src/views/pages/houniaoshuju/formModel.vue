	...
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"80%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">候鸟种类</div>
					<div  class="info_text" >{{detail.houniaozhonglei}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">观察日期</div>
					<div  class="info_text" >{{detail.guanchariqi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">观察地点</div>
					<div  class="info_text" >{{detail.guanchadidian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">观察数量</div>
					<div  class="info_text" >{{detail.guanchashuliang}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">观察行为</div>
					<div  class="info_text" >{{detail.guanchaxingwei}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">录入时间</div>
					<div  class="info_text" >{{detail.lurushijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">录入员</div>
					<div  class="info_text" >{{detail.luruyuan}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('houniaoshuju','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('houniaoshuju','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<div class="video_view">
			<video :src="$config.url + detail.paisheshipin" controls autoplay></video>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.houniaomingcheng
			bannerList.value = res.data.data.houniaotupian?res.data.data.houniaotupian.split(','):[]
