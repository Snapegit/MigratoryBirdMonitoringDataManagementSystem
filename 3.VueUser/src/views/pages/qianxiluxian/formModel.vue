	...
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"80%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">迁徙方向</div>
					<div  class="info_text" >{{detail.qianxifangxiang}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">迁徙时间</div>
					<div  class="info_text" >{{detail.qianxishijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">迁徙距离</div>
					<div  class="info_text" >{{detail.qianxijuli}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('qianxiluxian','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('qianxiluxian','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<el-tabs type="border-card" v-model="activeName" class="tabs_view">
			<el-tab-pane label="迁徙详情" name="first">
				<div v-html="detail.qianxixiangqing"></div>
			</el-tab-pane>
