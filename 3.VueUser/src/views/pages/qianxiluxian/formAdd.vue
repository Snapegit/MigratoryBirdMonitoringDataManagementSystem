			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="迁徙详情" prop="qianxixiangqing">
						<editor class="list_editor" :value="form.qianxixiangqing" placeholder="请输入迁徙详情" :readonly="!isAdd||disabledForm.qianxixiangqing?true:false"
							@change="(e)=>editorChange(e,'qianxixiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.qianxixiangqing = res.data.data.qianxixiangqing.replace(reg,'../../../cl8819411/file');
