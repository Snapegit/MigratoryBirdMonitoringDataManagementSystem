					...
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="luruyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in luruyuanxingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const tableName = ref('luruyuan')
	const user = ref({})
	const luruyuanxingbieLists = ref([])
	const init = () => {
		luruyuanxingbieLists.value = "男,女".split(',')
	}
	const luruyuantouxiangUploadSuccess=(fileUrls)=> {
