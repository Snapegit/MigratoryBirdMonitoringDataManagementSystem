		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="迁徙方向" prop="qianxifangxiang">
							<el-input class="list_inp" v-model="form.qianxifangxiang" placeholder="迁徙方向"
								 type="text" 								:readonly="!isAdd||disabledForm.qianxifangxiang?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="迁徙时间" prop="qianxishijian">
							<el-input class="list_inp" v-model="form.qianxishijian" placeholder="迁徙时间"
								 type="text" 								:readonly="!isAdd||disabledForm.qianxishijian?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="迁徙距离" prop="qianxijuli">
							<el-input class="list_inp" v-model="form.qianxijuli" placeholder="迁徙距离"
								 type="text" 								:readonly="!isAdd||disabledForm.qianxijuli?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="迁徙详情" prop="qianxixiangqing">
							<editor :value="form.qianxixiangqing" placeholder="请输入迁徙详情" :readonly="!isAdd||disabledForm.qianxixiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'qianxixiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const disabledForm = ref({
		...
		qidian : false,
		zhongdian : false,
		qianxifangxiang : false,
		qianxishijian : false,
		qianxijuli : false,
		qianxixiangqing : false,
		storeupnum : false,
	})
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.qianxixiangqing = res.data.data.qianxixiangqing?(res.data.data.qianxixiangqing.replace(reg,'../../../cl8819411/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='qianxifangxiang'){
					form.value.qianxifangxiang = row[x];
					disabledForm.value.qianxifangxiang = true;
					continue;
				}
				if(x=='qianxishijian'){
					form.value.qianxishijian = row[x];
					disabledForm.value.qianxishijian = true;
					continue;
				}
				if(x=='qianxijuli'){
					form.value.qianxijuli = row[x];
					disabledForm.value.qianxijuli = true;
					continue;
				}
				if(x=='qianxixiangqing'){
					form.value.qianxixiangqing = row[x];
					disabledForm.value.qianxixiangqing = true;
					continue;
				}
				if(x=='storeupnum'){
